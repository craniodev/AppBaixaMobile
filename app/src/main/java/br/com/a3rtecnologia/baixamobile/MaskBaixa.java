...
/**
 * Created by maclemon on 13/09/16.
 */
public class MaskBaixa implements TextWatcher {

    private static MaskBaixa instance;
    ...
    public MaskBaixa(String mask, EditText editText) {
        mMask = mask;
        mEditText = editText;
        initSymbolMask();
    }
