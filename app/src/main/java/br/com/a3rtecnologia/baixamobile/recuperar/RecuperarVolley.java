...
public class RecuperarVolley {
    ...
    public RecuperarVolley(Context mContext, Usuario usuario, DelegateAsyncResponse delegate) {
    ...
    private Response.Listener<Usuario> successListener() {
        return new Response.Listener<Usuario>() {
            ...
            @Override
            public void onResponse(Usuario usuario) {

                try {

                    delegate.processFinish(true);
                    StatusDialog dialog = new StatusDialog((Activity)mContext, "Recuperação de Senha", usuario.getResposta(), true);
        ...
        return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(InternetStatus.isNetworkAvailable(mContext)){
                    ...
                    delegate.processCanceled(false);
                    StatusDialog dialog = new StatusDialog((Activity)mContext, "Recuperação de senha", "Ocorreu um erro ao cadastrar \n" + error.networkResponse.statusCode, false);
